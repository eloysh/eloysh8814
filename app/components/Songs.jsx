  ...
  return (
    <section id="songs" className="reveal">
      ...
      <p className="text-center text-slate-300 mb-8">
        Выберите готовую или закажите эксклюзив под вашу историю.
      </p>
